...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [HttpGet("GetProductByDealOfTheDayWithCategoryAsync")]
        public async Task<IActionResult> GetProductByDealOfTheDayWithCategoryAsync()
        {
            var values = await _productRepository.GetProductByDealOfTheDayWithCategoryAsync();
            return Ok(values);
        }
